                ...
                <div className="flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div id="mobile-nav" className="flex md:order-2">
                        ...
                        <div className="relative hidden md:block">
                            ...
                            <input type="text" id="search-navbar_1" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
                        </div>
